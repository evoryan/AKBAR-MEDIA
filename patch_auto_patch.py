...
# Remove the old auto-patch block entirely
# It spans from "// --- AUTO PATCH NODE-ROUTEROS FOR !EMPTY BUG ---" to "// ------------------------------------------------"
old_block_pattern = r"// --- AUTO PATCH NODE-ROUTEROS FOR !EMPTY BUG ---.*?// ------------------------------------------------\n"
