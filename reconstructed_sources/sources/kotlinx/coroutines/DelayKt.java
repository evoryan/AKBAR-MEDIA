    ...
    */
    ...
    public static final Object delay(long timeMillis, Continuation<? super Unit> continuation) {
        ...
        if (timeMillis < Long.MAX_VALUE) {
            getDelay(cont.getContext()).mo8891scheduleResumeAfterDelay(timeMillis, cont);
        }
    ...
    public static final Object m8816delayVtjQ1oo(long duration, Continuation<? super Unit> continuation) {
        Object delay = delay(m8817toDelayMillisLRDsOJo(duration), continuation);
    ...
    public static final long m8817toDelayMillisLRDsOJo(long $this$toDelayMillis_u2dLRDsOJo) {
        boolean m8703isPositiveimpl = Duration.m8703isPositiveimpl($this$toDelayMillis_u2dLRDsOJo);
        if (m8703isPositiveimpl) {
            Duration.Companion companion = Duration.INSTANCE;
            return Duration.m8687getInWholeMillisecondsimpl(Duration.m8705plusLRDsOJo($this$toDelayMillis_u2dLRDsOJo, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        }
        if (m8703isPositiveimpl) {
