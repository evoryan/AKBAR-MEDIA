...
public final class FirebaseAIOnDeviceNotAvailableException extends FirebaseAIException {
    ...
    */
    public FirebaseAIOnDeviceNotAvailableException(com.google.firebase.ai.ondevice.interop.FirebaseAIOnDeviceNotAvailableException r3) {
        /*
            r2 = this;
            ...
            if (r0 != 0) goto Ld
            java.lang.String r0 = "Device doesn't support local models"
        Ld:
            r1 = r3
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.ai.type.FirebaseAIOnDeviceNotAvailableException.<init>(com.google.firebase.ai.ondevice.interop.FirebaseAIOnDeviceNotAvailableException):void");
    }
}
